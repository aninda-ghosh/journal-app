...
struct VerifyStorage {
    ...
    static func main() {
        ...
        do {
            ...
            assertEqual(allEntries[0].photos, [mediaResult.path], "Read entry photos must match")
            ...
            let resolvedPhoto = storage.resolveMedia(relPath: mediaResult.path)
